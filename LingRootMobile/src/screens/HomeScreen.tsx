...
const HomeScreen: React.FC = () => {
  ...
  const allFeatures = [
    ...
    {
      id: 8,
      title: language === 'tr' ? 'Podcast n8n' : 'Podcast n8n',
      description: language === 'tr' ? 'n8n ile podcast oluştur' : 'Create a podcast with n8n',
      icon: 'podcasts',
      color: '#8E44AD',
      screenName: 'Create',
      params: { mode: 'podcast' as const, podcastProvider: 'n8n' as const },
      featureKey: 'podcast',
    },
    {
      id: 11,
      title: language === 'tr' ? 'Podcast' : 'Podcast',
      description: language === 'tr' ? 'Google ile diyalog podcast oluştur' : 'Create a dialogue podcast with Google',
      icon: 'podcasts',
      color: '#6C5CE7',
      screenName: 'Create',
