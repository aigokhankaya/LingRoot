          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 relative">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xl absolute -top-4 -left-4">1</div>
                <h3 className="text-xl font-bold text-blue-700 mb-3 mt-4">İçeriğinizi Yükleyin</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 relative">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xl absolute -top-4 -left-4">2</div>
                <h3 className="text-xl font-bold text-blue-700 mb-3 mt-4">Seviyenizi Seçin</h3>
                <p className="text-gray-600">A1'den C2'ye kadar olan İngilizce seviyelerinden size en uygun olanı seçin.</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 relative">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xl absolute -top-4 -left-4">3</div>
                <h3 className="text-xl font-bold text-blue-700 mb-3 mt-4">Öğrenmeye Başlayın!</h3>
