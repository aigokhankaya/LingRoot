...
export default function InputSection({ onSubmit, isLoading }) {
  ...
  const [voice, setVoice] = useState('en-GB-Wavenet-B');
          ...
          <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 space-y-6 shadow-inner">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="input-field focus:ring-blue-500 focus:border-blue-500"
              >
                <option value="en-GB-Wavenet-B">Erkek Ses (İngiltere)</option>
                <option value="en-US-Wavenet-D">Erkek Ses (ABD)</option>
                <option value="en-US-Wavenet-F">Kadın Ses (ABD)</option>
              </select>
            </div>
          </div>
