...
- **File:** `backend/utils/inputExtractor.js`  
...
- **File:** `backend/utils/textProcessor.js`  
...
- **File:** `backend/utils/cefrAdapter.js`  
...
## Geliştirici Notları
- Tüm servis fonksiyonları `frontend/src/services/` klasöründe modülerdir.
